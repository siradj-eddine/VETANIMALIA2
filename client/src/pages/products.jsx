...
export default function Products() {
  ...
  return (
    <div className="max-w-full mx-auto px-6 py-10 flex justify-center flex-col items-center mt-[-100px] overflow-x-hidden" >
      {/* Title & Image */}
      ...
      {filteredProducts.length > 0 ? (
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 p-15">
          {filteredProducts.map((product) => (
            ...
            <div
              key={product.id}
              className="rounded-2xl w-[90%] overflow-hidden shadow-lg border border-gray-600 hover:shadow-xl transition-shadow"
            >
